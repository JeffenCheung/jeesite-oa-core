...
public class TestAuditService extends CrudService<TestAuditDao, TestAudit> {
	...
	/**
	 * get method, setProcIns for showTracePhoto feature
	 * 
	...
	public TestAudit get(String id) {
		TestAudit testAudit = new TestAudit(id);
		testAudit = super.get(testAudit);
		Act act = testAudit.getAct();
		if (act != null && StringUtils.isNotBlank(act.getProcInsId())) {
